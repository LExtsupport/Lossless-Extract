...
Supports Dolby TrueHD + Atmos, DTS-HD MA, and standard AC3/DTS/PCM tracks
No transcoding or quality loss — pure stream extraction
macOS and Windows native app fast with clean, efficient design and multithreading and batch extraction
Export to FLAC, MKA, M4A, DSF,DFF or Direct stream copy (only macOS app that supports DTS-HD MA and Atmos direct export to m4a containers for easy tagging and playback in Kodi)
Extract Dolby TrueHD (with Atmos), SACD DSD, and DTS-HD Master Audio in full fidelity preserving atmos metadata
Automatic tagging and artwork retrieval — album art, artist, title, and more
Smart renaming of files to song name in the output folder for consistent, library-ready file organization

Perfect for audiophiles, sound engineers, Home theater, and anyone who values uncompromised sound.
